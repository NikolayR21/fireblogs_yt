<template>
  <div class="create-post">
      ...
      <div class="container">
          ...
          <div class="editor">
              <vue-editor :editorOptions="editorSettings" placeholder="Write your blog post here..." v-model="blogHTML" useCustomImageHandler @image-added='imageHandler'></vue-editor>
          </div>
...
export default {
    ...
    methods: {
        fileChange(){
            ...
            this.$store.commit('createFileNameURL', URL.createObjectURL(this.file));
        },
        openPreview(){
...
.create-post{
    ...
    .router-button{
        ...
        &:hover{
            background: rgba(48,48,48, $alpha: .7);
        }
    }
