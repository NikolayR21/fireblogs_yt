  ...
  <div class="admin">
      <div class="container">
          ...
          <div class="admin-info">
              <h2>Add Admin</h2>
              <div class="input">
                  <input type="text" name="" id="addAdmins" placeholder="Enter user email to make them an admin" v-model="adminEmail">
              </div>
...
.admin{
    .container{
        ...
        .admin-info{
            border-radius: 8px;
            box-shadow: 0 4px 6px -1px rgba($color: #000000, $alpha: .1), 0 2px 4px -1px rgba($color: #000000, $alpha: .06);
            padding: 32px;
            background: #f1f1f1;
            display: flex;
